...
+-- alpine:3.6 (3.962 MB)                                                         ===========> official image
    ...
    |   `-- registry.gitlab.com/cha-node/ng:1.6.1-alpine (108 MB)                 ===========> this project ***
    |       |
    |      (+)-- registry.gitlab.com/cha-node/ng-testplat:1.6.1-alpine (285 MB)   ===========> for ng e2e and unit testing
    |       |

...
+-- alpine:3.8 (4.41 MB)                                    ====> official image
    ...
    |   |
    |   +-- anacha/ng:7.0.0-beta.4-alpine (330 MB)          ====> optional ***
    |   `-- anacha/ng:6.2.2-alpine (330 MB)                 ====> this project ***
    |       |
    |      (+)-- anacha/ng-testplat:6.2.2-alpine (330 MB)   ====> for ng e2e and unit testing
    |       |

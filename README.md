...
+-- alpine:3.9 (4.41 MB)                                    ====> official image
    |
    +-- node:11.13.0-alpine (70.30 MB)                      ====> official image
    |   |
    |   +-- anacha/ng:7.2.0-beta.1  -alpine (330 MB)        ====> optional ***
    |   `-- anacha/ng:7.3.8-alpine (330 MB)                 ====> this project ***
    |       |
    |      (+)-- anacha/ng-testplat:7.3.8-alpine (330 MB)   ====> for ng e2e and unit testing
    |       |

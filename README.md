...
+-- alpine:3.9 (4.41 MB)                                    ====> official image
    |
    +-- node:12.2.0-alpine (70.30 MB)                       ====> official image
    |   |
    |   +-- anacha/ng:8.0.0-rc.3-alpine (330 MB)            ====> optional ***
    |   `-- anacha/ng:7.3.9-alpine (330 MB)                 ====> this project ***
    |       |
    |      (+)-- anacha/ng-testplat:7.3.9-alpine (330 MB)   ====> for ng e2e and unit testing
    |       |
